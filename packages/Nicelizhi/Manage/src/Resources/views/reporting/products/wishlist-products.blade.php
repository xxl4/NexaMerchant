...
<div class="card card-primary">
    ...
    <div class="card-body">
    <div class="chart">
        <canvas id="total-products-added-to-wishlist" style="min-height: 350px; height: 350px; max-height: 350px; max-width: 100%;"></canvas>
    </div>
</div>
</div>
<!-- jQuery -->
...
<script>
    $(function () {
      ...
      var areaChartCanvas = $('#total-products-added-to-wishlist').get(0).getContext('2d')
