...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">@lang('admin::app.reporting.customers.index.customers-with-most-orders')</h3>
    </div>
    
    <div class="card-body">

        <div class="customers-with-most-orders">
...
<script>
    $(function () {
        ...
        $.ajax({
            ...
            $(".customers-with-most-orders").html();
