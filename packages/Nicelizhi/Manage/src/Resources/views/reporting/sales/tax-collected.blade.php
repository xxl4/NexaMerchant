...
<div class="card card-primary">
    ...
    <h3 class="card-title">@lang('admin::app.reporting.sales.index.tax-collected')</h3>
    ...
    <div class="card-body">
    <div class="chart">
        <canvas id="taxcollected" style="min-height: 350px; height: 350px; max-height: 350px; max-width: 100%;"></canvas>
    </div>
</div>
</div>
<!-- jQuery -->
...
<script>
    $(function () {
      ...
      var areaChartCanvas = $('#taxcollected').get(0).getContext('2d')
