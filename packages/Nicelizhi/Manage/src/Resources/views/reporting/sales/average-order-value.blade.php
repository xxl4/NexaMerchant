...
<div class="card card-primary">
    ...
    <h3 class="card-title">@lang('admin::app.reporting.sales.index.average-sales')</h3>
    ...
    <div class="card-body">
    <div class="chart">
        <canvas id="averagesales" style="min-height: 350px; height: 350px; max-height: 350px; max-width: 100%;"></canvas>
    </div>
</div>
</div>
<!-- jQuery -->
...
<script>
    $(function () {
      ...
      var areaChartCanvas = $('#averagesales').get(0).getContext('2d')
