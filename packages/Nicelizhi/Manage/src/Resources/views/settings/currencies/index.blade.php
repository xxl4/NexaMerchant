<x-admin::layouts>
  ...
  <section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>@lang('admin::app.settings.currencies.index.title')</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">@lang('admin::app.settings.currencies.index.title')</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">@lang('admin::app.settings.currencies.index.title')</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
...
<script>
    $(function () {
      $("#tables").DataTable({
        ...
        keys: true,
        ajax: {
          url: "{{ route('admin.settings.currencies.index') }}",
          type: 'GET'
        },
        columns: [
          {
