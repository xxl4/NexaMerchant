...
namespace Nicelizhi\Manage\DataGrids\Marketing\Communications;
...
class EmailTemplateDataGrid extends DataGrid
{
    ...
    {
        if (bouncer_manage()->hasPermission('marketing.communications.email-templates.edit')) {
            $this->addAction([
                'icon'   => 'icon-edit',
        ...
        if (bouncer_manage()->hasPermission('marketing.communications.email-templates.delete')) {
            $this->addAction([
                'icon'   => 'icon-delete',
