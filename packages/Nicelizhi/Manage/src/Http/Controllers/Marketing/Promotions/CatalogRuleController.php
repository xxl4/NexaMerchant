...
namespace Nicelizhi\Manage\Http\Controllers\Marketing\Promotions;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Nicelizhi\Manage\Http\Controllers\Controller;
use Webkul\CatalogRule\Repositories\CatalogRuleRepository;
use Nicelizhi\Manage\DataGrids\Marketing\Promotions\CatalogRuleDataGrid;
use Nicelizhi\Manage\Http\Requests\CatalogRuleRequest;
