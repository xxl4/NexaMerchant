...
<body>
            ...
            <div class="payoptbox">
              ...
              <div class="payment-flds-box credit-card">
                ...
                <div class="frm-flds half-fld fl">
                  ...
                  <select name="expmonth" class="selcet-fld required frmField month_exp remove" data-error-message="Please select a valid expiration month!">
                ...
                <div class="frm-flds fl half-fld billing-cvv">
                  ...
                  <input type="tel" name="CVV" class="input-flds fl-input required frmField remove" placeholder="CVV" id="cvv" data-validate="cvv" maxlength="3" data-error-message="Please enter a valid CVV code!" />
                </div>
  ...
  <script>
    ...
    function addToCart(pay_type) {
      ...
      var total =
        product_info.product_price * 1 + product_info.shipping_fee * 1

      var phone_number = $('.phone_number').val()
      var phone_prefix = getPhonePrefix()

      var products = getSubmitProducts(
        product_info.product_price,
        product_info.amount
      )

      var url =
        '/api/checkout/cart?_token=tcp19tASqLc2mcXv57kyBxRM0ZxAZk12nN47LZqP&time=' +
        new Date().getTime()
    ...
    function createOrder(
      token,
      token_field = 'checkout_frames_token',
      pay_type = 'checkout',
      card = {}
    ) {
      //商品加入到购车中
      ...
      var url =
        '/onebuy/order/add/sync?currency=USD&_token=tcp19tASqLc2mcXv57kyBxRM0ZxAZk12nN47LZqP&time=' +
        new Date().getTime()
          ...
          if (data.result === 200) {
            ...
            if (window.is_airwallex_klarna) {
              document.cookie =
                ...
                order_info.order_currency_code +
                '; path=/'
              document.cookie = 'order_id=' + order_info.id + '; path=/'
              localStorage.setItem('order_id', order_info.id)
              ...
              url =
                '/onebuy/order/confirm?currency=USD&_token=tcp19tASqLc2mcXv57kyBxRM0ZxAZk12nN47LZqP&payment_intent_id=' +
            ...
            if (window.is_airwallex) {
              ...
              Airwallex.confirmPaymentIntent({
                ...
                .then((response) => {
                  ...
                  window.location.href =
                    '/onebuy/checkout/v1/success/' + data.order.id
                  return false
                })
                .catch((response) => {
                  $('#loading').hide()
    ...
    function getOrderParams(
      ...
      var params = {
        ...
        phone_full: phone_number ?
          phone_number.indexOf(phone_prefix) == 0 ?
          phone_number :
        ...
        payment_return_url: window.location.protocol +
          '//' +
          window.location.host +
          '/template-common/en/thankyou1/?' +
          GetRequest(),
      ...
      if (!params['error']) {
        params['error'] = checkout_function[pay_type] ?
          checkout_function[pay_type](
            params,
            is_chain_payment,
            cancel_check_scroll
          ) :
          checkOrderParams(params, is_chain_payment, cancel_check_scroll)
      } else {
        var checkout_err = checkout_function[pay_type] ?
          checkout_function[pay_type](
            params,
            is_chain_payment,
            cancel_check_scroll
    ...
    function checkoutProducts(params) {
      ...
      try {
        if (isProductSoldOut && isProductSoldOut()) {
          return [
            'Sorry, the Attributes you selected is sold out, please select again',
          ]
        }
      } catch (err) {}
    ...
    function checkoutAmount(params) {
      ...
      if (params_amount != product_amount) {
        return [
          'The actual quantity of the product does not match the selected quantity, please re-select the quantity and attributes of the product.',
        ]
      }
    ...
    function clearError() {
      $('.shipping-info-item input, .shipping-info-item select').each(
        function() {
    ...
    function checkOrderParams(params, is_chain_payment, cancel_check_scroll) {
      ...
      if (
        (params.payment_method == 'checkout' && !Frames.isCardValid()) ||
        (params.payment_method == 'stripe' &&
          !(
            window.card_number_vaild &&
            window.card_expriy_vaild &&
            window.card_cvc_vaild
          )) ||
        (params.payment_method == 'wintopay' && !cc_form_obj.isValid())
      ) {
        has_error = true
    ...
    function showError(id, error_log) {
      ...
      $('#' + id)
        .parent()
        .find('input')
        .addClass('shipping-info-input-error')
    }
    ...
    function getAttributeImg(attribute) {
      var product_attributes = [{
        ...
        },
        {
          ...
          options: [{
              ...
              swatch_value: null,
              products: [
                3171, 3197, 3198, 3199, 3200, 3201, 3202, 3203, 3204,
              ],
            ...
            },
            {
              ...
              swatch_value: null,
              products: [
                3168, 3173, 3174, 3175, 3176, 3177, 3178, 3179, 3180,
              ],
            ...
            },
            {
              ...
              swatch_value: null,
              products: [
                3169, 3181, 3182, 3183, 3184, 3185, 3186, 3187, 3188,
              ],
            ...
            },
            {
              ...
              swatch_value: null,
              products: [
                3170, 3189, 3190, 3191, 3192, 3193, 3194, 3195, 3196,
              ],
      ...
      var product_img =
        'https://shop.hatmeo.com/cache/small/product/3167/1_f3710786-04cc-41f0-9837-6004fa6114ae.webp'
    ...
    function changeOrderSummary(position = '') {
      ...
      $('.js-discount-price').html(
        getFormatPrice(product.new_price - product.old_price)
      )
