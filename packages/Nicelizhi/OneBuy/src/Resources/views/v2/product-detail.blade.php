    ...
    <div data-id="<?php echo $package_product['id'];?>" class="list-item js-list-item item-<?php echo $key+5;?><?php if($key==0) { ?> list-item--checked <?php } ?>" style="order: 0;">
        ...
        <div class="list-item-content">
            ...
            <div class="list-item-image">
                <img src="/onebuy/v2/products/<?php echo $product->id."_".$package_product['id'];?>.jpg" />
            </div>
...
<div class="attribute-select" style="display:none">
</div>
...
<script>
        ...
        window.is_airwallex_dropin = pay_type == 'airwallex_dropin' ? true : false;
        ...
        function checkout() {
            ...
            }else if(window.is_airwallex_dropin) {
                createOrder('', '', 'airwallex_dropin');
            }
        ...
        function createOrder(token, token_field="checkout_frames_token", pay_type="checkout", card={}) {
            ...
            .then(function(res) {
                ...
                if(data.result === 200){
                    ...
                    if(window.is_airwallex_dropin) {
                        console.log(window.is_airwallex_dropin);
                    }
