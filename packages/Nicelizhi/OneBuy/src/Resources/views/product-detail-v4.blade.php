            ...
            <div class="main-container-progress-inner">
                <div class="main-container-progress-state state-1">
                    <div class="main-container-progress-state-content">
                        ...
                        <div class="main-container-progress-state-content-step-title black">@lang('onebuy::app.product.step.Select Quantity')</div>
                    </div>
                ...
                <div class="main-container-progress-state state-2">
                    <div class="main-container-progress-state-content">
                        ...
                        <div class="main-container-progress-state-content-step-title">@lang('onebuy::app.product.step.Payment') </div>
                    </div>
                ...
                <div class="main-container-progress-state state-3">
                    <div class="main-container-progress-state-content">
                        ...
                        <div class="main-container-progress-state-content-step-title">@lang('onebuy::app.product.step.Shipping Information') </div>
                    </div>
                ...
                <div class="main-container-progress-state state-4">
                    <div class="main-container-progress-state-content">
                        ...
                        <div class="main-container-progress-state-content-step-title">@lang('onebuy::app.product.step.Place Order')  </div>
                    </div>
            </div>
        </div>
    </div>
        ...
        <div class="product-content">
            <div class="checkout-security">
                <div class="checkout-security-title">
                    ...
                    <div class="checkout-security-title-font">@lang('onebuy::app.product.order.Secure Checkout') </div>
                </div>
