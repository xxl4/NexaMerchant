...
class Get extends Command
{
    ...
    public function handle()
    {
        ...
        if ($force) {
            ...
            // 5585627676902
            $base_url = $shopify['shopify_app_host_name'].'/admin/api/2023-10/orders.json?status=any&fulfillment_status=shipped&updated_at_min='.$processed_at_min.'&updated_at_max='.$processed_at_max.'&limit=250';
