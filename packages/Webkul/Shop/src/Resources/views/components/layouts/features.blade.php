...
<div class="container mt-20 max-lg:px-[30px] max-sm:mt-[30px]">
    <div class="flex gap-[40px] justify-center max-lg:flex-wrap">
        <div class="flex items-center gap-[40px]">
            ...
            <div class="">
                <p class="text-[16px] font-medium font-dmserif">Free Shipping Worldwide</p>

                <p class="text-[14px] font-medium mt-[10px] text-[#6E6E6E] max-w-[217px]">
                Our Customers Are Not Only In The United States, We Support Worldwide Free Shipping On Orders Over $69
                </p>
            </div>
        </div>
        ...
        <div class="flex items-center gap-[40px]">
            ...
            <div class="">
                <p class="text-[16px] font-medium font-dmserif">30-Day Return Guarantee</p>

                <p class="text-[14px] font-medium mt-[10px] text-[#6E6E6E] max-w-[217px]">
                For Unsatisfactory Orders Within 30 Days, If You Are Not Completely Satisfied, Return Them For A Full Refund
                </p>
            </div>
        </div>

        <div class="flex items-center gap-[40px]" style="display:none;">
        ...
        <div class="flex items-center gap-[40px]">
            ...
            <div class="">
                <p class="text-[16px] font-medium font-dmserif">Secure Payments</p>

                <p class="mt-[10px] text-[14px] text-[#6E6E6E] font-medium max-w-[217px]">
                Your data security & privacy is our priority. Pay securely through 128 bit encrypted payment gateway
                </p>
            </div>
        </div>
    </div>
