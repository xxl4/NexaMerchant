...
class OnePageController extends Controller
{
    ...
    public function success(Request $request)
    {
        ...
        if (isset($request->transactionid)) {
            ...
            Log::info("multipay notification received for order id:" . $transactionId);
    ...
    /**
     * Store payment information in session for airwallex.
     *
     * This method is responsible for storing payment information related to airwallex
     * in the session. It checks if the current payment method in the cart is airwallex,
    ...
    {
        $cart = Cart::getCart();
        if ($cart->payment->method === 'airwallex') {
