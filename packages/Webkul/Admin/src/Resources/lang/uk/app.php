...
=======
                ...
                'magic-ai' => [
                    ...
                    'settings' => [
                        ...
                        'title-info'   => 'Покращте свій досвід з функцією Magic AI, введіть свій ексклюзивний API-ключ та вкажіть відповідну Організацію для беззавдання інтеграції. Оволодійте своїми обліковими записами OpenAI та налаштуйте параметри з урахуванням своїх конкретних потреб.',
                        'enabled'      => 'Увімкнено',
                        'api-key'      => 'API-ключ',
                    ...
                    'review-translation' => [
                        ...
                        'title-info' => 'Дайте можливість клієнту або відвідувачеві перекласти відгук клієнта англійською.<br/><br/>Коли увімкнено, переходьте до відгуків, і ви знайдете кнопку "Перекласти англійською", якщо відгук не англійською мовою.',
                        'enabled'    => 'Увімкнено',
                    ],

                    'checkout-message' => [
                        'title'      => 'Персоналізоване повідомлення при оформленні замовлення',
                        'title-info' => 'Створіть персоналізоване повідомлення при оформленні замовлення для клієнтів на сторінці подяки, налаштовуючи зміст під індивідуальні вподобання та покращуючи загальний доспродажний досвід.',
                        'enabled'    => 'Увімкнено',
                        'prompt'     => 'Підказка',
                    ],
                ],
