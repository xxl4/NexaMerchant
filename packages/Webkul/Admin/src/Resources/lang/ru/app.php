...
=======
                ...
                'magic-ai' => [
                    ...
                    'settings' => [
                        ...
                        'title-info'   => 'Улучшите свой опыт с функцией Magic AI, введя свой эксклюзивный API-ключ и указав соответствующую организацию для беспроблемной интеграции. Получите контроль над вашими учетными данными OpenAI и настройте параметры согласно вашим конкретным потребностям.',
                        'enabled'      => 'Включено',
                        'api-key'      => 'API-ключ',
                    ...
                    'review-translation' => [
                        ...
                        'title-info' => 'Предоставьте возможность клиенту или посетителю перевести отзыв клиента на английский.<br/><br/>Когда включено, перейдите к отзывам, и вы найдете кнопку "Перевести на английский", если отзыв не на английском языке.',
                        'enabled'    => 'Включено',
                    ],

                    'checkout-message' => [
                        'title'      => 'Персонализированное сообщение при оформлении заказа',
                        'title-info' => 'Создайте персонализированное сообщение при оформлении заказа для клиентов на странице благодарности, настраивая контент под индивидуальные предпочтения и улучшая общий постпокупочный опыт.',
                        'enabled'    => 'Включено',
                        'prompt'     => 'Подсказка',
                    ],
                ],
...
=======
        ...
        'tinymce' => [
            ...
            'ai-generation' => [
                ...
                'generated-content-info' => 'Содержимое ИИ может вводить в заблуждение. Пожалуйста, просмотрите сгенерированный контент перед его применением.',
                'apply'                  => 'Применить',
            ],
        ],
>>>>>>> 6db7346497c8511a570d5e8471c9287634998b61
